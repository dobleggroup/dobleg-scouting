...
export const RANKING_WIDGETS: RankingWidgetDef[] = [
  ...
  },
  {
    ...
    description: 'Qué porcentaje de los duelos en ataque gana. Al lado, cuántos disputa y cuántos gana cada 90 minutos.',
    columns: [
    ...
    minAttempts: { per90: 'off_duels_p90', min: 20, label: 'duelos en ataque' },
  },
  {
  ...
  },
  {
    ...
    description: 'Qué porcentaje de sus regates le sale. Al lado, cuántos intenta y cuántos le salen cada 90 minutos.',
    columns: [
    ...
    minAttempts: { per90: 'dribbles_p90', min: 10, label: 'regates' },
  },
  {
    id: 'centros', title: 'Centros',
    description: 'Qué porcentaje de sus centros llega a un compañero. Al lado, cuántos tira y cuántos llegan cada 90 minutos.',
    columns: [
    ...
    minAttempts: { per90: 'crosses_p90', min: 10, label: 'centros' },
  },
  {
...
export const FULL_TABLE_COLUMNS: MetricColumn[] = [
  ...
  { key: 'off_duels_won_pct', label: 'Duelos at. %', format: 'pct', perMinute: true },
