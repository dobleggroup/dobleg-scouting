...
export const SCATTER_DEFS: ScatterDef[] = [
  {
    id: 'centrales-duelos', group: 'centrales', title: 'Centrales: duelos defensivos y aéreos',
  ...
  {
    id: 'centrales-salida', group: 'centrales', title: 'Centrales: duelos ganados y pases progresivos',
  ...
  {
    id: 'laterales', group: 'laterales', title: 'Laterales: centros precisos y duelos defensivos',
  ...
  {
    id: 'volantes-recupera', group: 'volantes', title: 'Volantes: intercepciones y pases progresivos',
  ...
  {
    id: 'delanteros-gol', group: 'delanteros', title: 'Delanteros: xG y goles',
    question: 'Goles esperados (xG) contra goles hechos, cada 90 minutos.',
    x: p90('xg_p90', 'xG/90'),
    y: p90('goals_p90', 'Goles/90'),
  },
  {
    id: 'delanteros-area', group: 'delanteros', title: 'Delanteros: duelos en ataque y toques en el área',
