  ...
  return (
    <div className="space-y-4 animate-fade-in">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <p className="flex items-start gap-2 text-xs text-apple-gray-500 dark:text-apple-gray-400 max-w-md rounded-lg bg-brand-green/[0.07] border border-brand-green/20 px-3 py-2">
          <svg className="w-4 h-4 flex-shrink-0 text-brand-green mt-px" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
