...
function ChipGroup({ title, hint, stats, selected, onChange }: ChipGroupProps) {
...
export default function Step2Metricas({ stats, charts, onChangeCharts, onBack, onNext }: Step2MetricasProps) {
